  ...
  <AppLayout :breadcrumbs="breadcrumbs">
    <div class="flex h-full flex-1 flex-col gap-4 p-4 md:p-6">
      ...
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <h1 class="text-2xl font-bold text-secondary-900 dark:text-white">Edit Kategori Pengeluaran</h1>
      ...
      <div class="bg-white dark:bg-slate-800 text-secondary-900 dark:text-white rounded-xl shadow border border-slate-200 dark:border-slate-700 overflow-hidden">
        <div class="p-6 border-b border-slate-200 dark:border-slate-700">
          <div>
            <h2 class="text-lg font-medium text-secondary-900 dark:text-white">Form Edit Kategori Pengeluaran</h2>
            <p class="text-secondary-600 dark:text-secondary-400 mt-1">Edit detail kategori pengeluaran Anda</p>
          </div>
        </div>
        <div class="p-6">
...
const breadcrumbs: BreadcrumbItem[] = [
  ...
  {
    title: 'Edit Kategori',
    href: route('admin.expense-categories.edit', props.category.id),
  }
];
...
const form = useForm({
  ...
  color: props.category.color || '#3B82F6', // Default color (blue)
